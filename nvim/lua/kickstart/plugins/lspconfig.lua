...
return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- The following code add signature help to the LSP handlers if the client supports it
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if
            client
            and client.supports_method(vim.lsp.protocol.Methods.textDocument_signatureHelp)
          ...
          then
            ...
            vim.api.nvim_create_autocmd({ 'CursorHold', 'CursorHoldI' }, {
              ...
              callback = function()
                ...
                vim.diagnostic.open_float({ focus = false }, 0)
